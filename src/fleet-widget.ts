 ...
 * disposeFleetUI) and the widget's row assembly (buildWidgetRows). The
 * delegate-family tool-result rendering lives in ui-text.ts
 * (renderDelegateLines); the idle nudge was removed with the /delegate-fleet
 * overlay (operator decision). Moved verbatim out of the old
